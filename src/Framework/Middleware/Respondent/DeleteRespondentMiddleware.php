...
class DeleteRespondentMiddleware extends ShieldMiddleware
{
    public function __construct(Container $container)
    {
        ...
        $this->allow((new PrivateAccess())
            ->addCheckpoint((new Checkpoint('reap', 'respondents'))->delete()
                ->strict(true)
                /**
                 * Requirement: id
                 * Use case: Respondent is only allowed to delete their own account
                 */
